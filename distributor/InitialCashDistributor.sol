...
import '../distribution/HSCUSDTPool.sol';
import '../distribution/HSCHETHPool.sol';
import '../distribution/HSCAAVEPool.sol';
import '../distribution/HSCHTPool.sol';
import '../distribution/HSCUNIPool.sol';
...
contract InitialCashDistributor is IDistributor {
    ...
    constructor(
        ...
        require(_pools.length != 0, 'a list of HSC pools are required');
